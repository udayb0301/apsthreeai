...
// //       <div className="bg-slate-200">
// //         {/* ye div daala */}
// //         <div className="p-4 sm:p-6 lg:p-10 m-6">
// //           {/* First Section */}
// //           <div className="p-6 lg:p-4 flex flex-col lg:flex-row gap-6 max-w-6xl mx-auto lg:my-0">
// //             {/* Left Section - Large Image */}
// //             <div className="flex-1  overflow-hidden">
...
// //             {/* Right Section - Blog Images with Titles */}
// //             <div className="bg-white p-6 rounded-[24px] flex-1 w-full lg:max-w-md lg:m-0 lg:space-y-0">
// //               {/* <div className="bg-white p-6 rounded-[24px]  flex-1 w-full lg:max-w-md  sm:mb-72 space-y-4"> */}
// //               <h3 className="text-gray-800 text-xl font-semibold mb-2 space-y-2">
// //                 Other Blogs
// //               </h3>
...
// //           {/* idhar se div nikala */}
// //           {/* ERP Solutions Section */}
// //           <section className="max-w-6xl mx-auto p-4 sm:p-6 lg:p-16 bg-white shadow-md rounded-[12px] mb-12 mt-0">
// //             <header className="mb-6">
// //               <p className="text-xs sm:text-sm text-gray-500 flex items-center space-x-2">
...
// //                 </p>
// //                 <p className="mt-2 text-sm sm:text-base text-gray-700">
// //                   Our multi-device support allows staff to access the platform
// //                   from desktop and mobile, ensuring billing can happen even
// //                   on-the-go.
// //                 </p>
// //               </div>
...
// //                 <ul className="list-disc list-inside text-sm sm:text-base text-gray-700">
// //                   <li>
// //                     <strong>Doctor App:</strong> Manage appointments, view
// //                     patient history, and coordinate with pharmacy staff.
// //                   </li>
// //                   <li>
// //                     <strong>Patient App:</strong> View prescriptions, schedule
// //                     appointments, and track bills.
// //                   </li>
// //                   <li>
// //                     <strong>Hospital App:</strong> Centralize all administrative
// //                     tasks, including staffing and equipment management.
// //                   </li>
// //                 </ul>
// //               </div>
// //             </section>
...
// //             <section className="max-w-6xl mx-auto p-4 sm:p-6 lg:p-8 bg-white shadow-md rounded-[12px]">
// //               <h2 className="text-2xl sm:text-3xl font-bold text-gray-900">
// //                 Explore More Things
// //               </h2>
// //               <p className="mt-2 text-sm sm:text-base text-gray-700">
// //                 Discover other features, articles, and resources to help you
// //                 stay ahead in healthcare technology.
// //               </p>
// //             </section>
// //           </div>
// //         </div>
